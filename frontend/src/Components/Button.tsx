...
export default function Button({
  ...
  return (
    <button
      disabled={disabled}
      type={type}
      className={`flex h-full justify-center items-center rounded-md font-semibold leading-6 whitespace-nowrap focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 ${
